...
// ==================== FILTER BARIS VALID (FIXED TOTAL) ====================
function isValidLine(line) {
  ...
  // Cek apakah ada http:// atau https:// atau langsung ip:port
  if (trimmed.startsWith('http://') || trimmed.startsWith('https://')) return true;
  // Cek langsung ip:port (tanpa protocol)
...
async function main() {
  ...
  const allProxies = new Set([...proxyScrapeProxies, ...databayProxies, ...proxiflyProxies, ...thordataProxies, ...vpslabProxies]);
