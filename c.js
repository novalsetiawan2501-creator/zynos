...
const EXTRA_SOURCES = [
  ...
  { url: 'https://raw.githubusercontent.com/proxyscrape/free-proxy-list/main/proxies/protocols/https/data.txt' },
  ...
  { url: 'https://raw.githubusercontent.com/Riyoway/proxies/master/http.txt' },
  ...
  { url: 'https://raw.githubusercontent.com/xyzs996/free-proxy-health-list/main/proxies/protocols/http/data.txt' },
  ...
  { url: 'https://raw.githubusercontent.com/roosterkid/openproxylist/master/HTTPS_RAW.txt' },
  ...
  { url: 'https://raw.githubusercontent.com/cyberh4ck3r/free-proxy-list/main/http-proxies.txt' },
  { url: 'https://raw.githubusercontent.com/cyberh4ck3r/free-proxy-list/main/https-proxies.txt' },
  { url: 'https://raw.githubusercontent.com/gproxynet/free-proxy-list/main/http.txt' },
  { url: 'https://raw.githubusercontent.com/officialputuid/ProxyForEveryone/main/http/http.txt' },
  { url: 'https://raw.githubusercontent.com/officialputuid/ProxyForEveryone/main/https/https.txt' },
  { url: 'https://raw.githubusercontent.com/dinoz0rg/proxy-list/main/checked_proxies/http.txt' },
  { url: 'https://raw.githubusercontent.com/elliottophellia/proxylist/main/results/http/global/http_checked.txt' },
  { url: 'https://raw.githubusercontent.com/elliottophellia/proxylist/main/results/http/global/phttp_checked.txt' },
  { url: 'https://raw.githubusercontent.com/gfpcom/free-proxy-list/main/sources/http.txt' },
  { url: 'https://raw.githubusercontent.com/gfpcom/free-proxy-list/main/sources/https.txt' },
  { url: 'https://raw.githubusercontent.com/gnxD3RfTT2WE/http-proxy-list-2026/main/http.txt' },
  { url: 'https://raw.githubusercontent.com/gnxD3RfTT2WE/free-proxy-pool-2026/main/http.txt' },
];
...
async function scrapeExtraSources() {
  ...
  for (const source of EXTRA_SOURCES) {
    try {
      ...
      if (lines.length > 0) {
        total += lines.length;
        console.log(`   [+] ${source.url.split('/').pop()}: ${lines.length} proxy`);
      }
    } catch (err) {
      // Skip
    }
...
async function main() {
  ...
  console.log(`   Extra Sources:   ${extraProxies.size}`);
