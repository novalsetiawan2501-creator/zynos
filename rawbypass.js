...
if (process.argv.length <= 3) {
    console.log("node rawbypass.js target time");
    console.log("node rawbypass.js target time proxy.txt (pake proxy)");
    process.exit(-1);
}
...
if (useProxy) {
    try {
        ...
        console.log('❌ Gagal load ' + proxyFile);
        process.exit(-1);
    }
}

console.log('⏱️ Attack selama ' + time + ' detik ke ' + target);
